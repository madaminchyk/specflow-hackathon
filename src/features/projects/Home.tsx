  ...
  return (
    <>
      ...
      <main className="home" data-revision={refresh}>
        ...
        <section className="demo-brief" aria-labelledby="demo-brief-title">
          <span className="eyebrow">КЕЙС «ИЗ РАЗГОВОРА В ТЗ»</span>
          <h2 id="demo-brief-title">Рабочий MVP за 24 часа</h2>
          <p className="demo-brief-lead">
            Проверенный реальный AI-путь: аудио → транскрипция → требования
          </p>
          <p>
            За 24 часа мы собрали полный сценарий: Yandex SpeechKit распознаёт запись, YandexGPT
            формирует требования, роли и критерии, аналитик проверяет и редактирует результат.
            Каждый шаг работает на реальных данных, без имитации обработки.
          </p>
          <p className="notice">
            <strong>Ограничение демо: до 30 секунд и 1 МБ.</strong> Это техническая граница текущего
            MVP, а не финальный продуктовый лимит. Для демонстрации длинной встречи используйте
            учебное демо или готовую транскрипцию.
          </p>
          <div className="demo-brief-columns">
            <div>
              <h3>Что уже работает</h3>
              <ul>
                <li>Импорт готовой транскрипции</li>
                <li>Реальная расшифровка короткого аудио через Yandex SpeechKit</li>
                <li>Анализ требований через YandexGPT</li>
                <li>Ручная правка требований</li>
                <li>Источники и критерии приёмки</li>
                <li>Экспорт JSON, текста (Markdown), DOCX и печать в PDF</li>
              </ul>
            </div>
            <div>
              <h3>Что дальше</h3>
              <ul>
                <li>Длинные аудио: встречи на 30–90 минут</li>
                <li>Очередь обработки, статусы и уведомления</li>
                <li>Роли в команде и совместная работа</li>
                <li>Интеграции с Telegram, VK и Max</li>
              </ul>
            </div>
          </div>
          <p className="muted">
            Roadmap длинных встреч: асинхронный SpeechKit → Object Storage для больших файлов →
            очередь задач → фоновый worker → статусы обработки и уведомления. Этот режим
            запланирован для следующей версии.
          </p>
        </section>
        {(error || corrupt) && (
        ...
        >
          ...
          <div className="sample-download-card">
            ...
            >
              Скачать тестовую WAV-запись
            </a>
            <p className="sample-download-meta">
              28,6 сек · 915 КБ · уже проверена через SpeechKit
            </p>
            <p>Скачайте файл и загрузите его обратно в приложение для live-проверки AI.</p>
          </div>
          <p className="muted">
            Встроенный демо-проект — подготовленная учебная транскрипция и сценарий для быстрого
